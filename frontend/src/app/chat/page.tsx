...
export default function ChatPage() {
  return (
    <div className="flex h-screen bg-gray-100 overflow-hidden"> {/* overflow-hidden für den Hauptcontainer */}
      
      {/* Linke Sidebar für Gliederung, Dateien, Quellen */}
      <SideMenu /> {/* Dein neues SideMenu hier einfügen */}

      {/* Mittlerer Bereich: Tiptap Editor */}
      <div className="flex-grow p-4 flex flex-col"> {/* flex-col, damit Editor Höhe füllt */}
        ...
        <div className="flex-grow bg-white rounded-lg shadow-md border border-gray-200 p-1"> {/* p-1 oder p-2 */}
      ...
      <div className="w-80 border-l border-gray-200 bg-white shadow-sm flex-shrink-0"> {/* flex-shrink-0 verhindert Schrumpfen */}
